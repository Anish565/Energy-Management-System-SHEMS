  ...
  return (
      ...
      <h2 className='flex-block text-4xl text-white font-bold m-1.5'>Register</h2>
        <form className='min-w-md'>
          ...
          <FormTextElement id='email' OnChange={(e) => setUser(e.target.value)} type='email' placeholder='Email' d1="m10.036 8.278 9.258-7.79A1.979 1.979 0 0 0 18 0H2A1.987 1.987 0 0 0 .641.541l9.395 7.737Z" d2="M11.241 9.817c-.36.275-.801.425-1.255.427-.428 0-.845-.138-1.187-.395L0 2.6V14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2.5l-8.759 7.317Z"/>
