    ...
    // <div className='h-screen flex flex-col justify-center items-center gap-4'>
      ...
      <h2 className='flex-block text-4xl text-white font-bold m-1.5'>Login</h2>
        <form className='min-w-md'>
          ...
          <FormTextElement id='email' type='email' OnChange={(e) => setUsername(e.target.value)} placeholder='Email' d1="m10.036 8.278 9.258-7.79A1.979 1.979 0 0 0 18 0H2A1.987 1.987 0 0 0 .641.541l9.395 7.737Z" d2="M11.241 9.817c-.36.275-.801.425-1.255.427-.428 0-.845-.138-1.187-.395L0 2.6V14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2.5l-8.759 7.317Z"/>
          ...
          <button type="submit" onClick={handleLogin} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
